...
export default function LoginPage() {
  ...
  const [error, setError] = useState(
    errorParam === 'google' ? 'Google sign-in failed. Try again.' :
    errorParam === 'google_not_configured' ? 'Google sign-in is not configured on the server.' : ''
  )
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center overflow-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="bg-[#13131a] border border-white/10 rounded-2xl p-10 shadow-2xl">
          ...
          {/* Google OAuth — must hit backend directly for redirect to work */}
